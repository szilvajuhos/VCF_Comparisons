...
//            n = chr.find("chr");
  //          chr = chr.substr(3, chr.length());
        ...
        if (chr.find("GL") == string::npos && chr.find("MT") == string::npos) { // if it is a variant site and a SNP
            string address = "";
            address.append(chr);
            address.append("_");
