...
ofstream ofile("vcf_stats_nofilter.txt");
...
//    return 0;
    ...
    //truthsetfile = argv[1];
    truthsetfile = "/pica/v12/b2013064_nobackup/private/pelin/ANALYSIS/SwedishGenomePilot/Comparisons/genotypes_CEU_r28_nr.b37_fwd.filtered.sortedbyRs";
...
//    hapmapgenotypes.PrintVariantTypes(metavcf);
